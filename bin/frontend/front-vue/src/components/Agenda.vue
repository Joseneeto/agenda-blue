            ...
            <div class="flex justify-content-center">
                <div class="card">
                    <form class="p-fluid">
                        ...
                        <Button type="submit" label="Cadastrar" class="mt-2" v-on:click="cadastrar"></Button>
...
export default {
    ...
    methods:{
        async listar()
        {
            let result = await axios.get("http://localhost:8080/listar");
        ...
        async cadastrar()
        {
            ...
            const result = await axios.post("http://localhost:8080/cadastrar",{
            name:this.name,
            email:this.email,
            phone:this.phone,
            });                       
        ...
        {            
            let result = await axios.delete('http://localhost:8080/remover/'+id);
            console.warn(result);
        ...
        {            
            const result = await axios.put("http://localhost:8080/alterar/",{
            id: this.agenda.id,
